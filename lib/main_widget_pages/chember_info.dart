            ...
            children: [
              Row(
                children: [
                  ...
                  SizedBox(width: 10.0,),
                  Text("Professor Dr.Nasir Uddin",style: TextStyle(fontSize: 25.0,fontWeight: FontWeight.w600,color: Colors.pink),),
                ],
              ),
              ...
              Text("Dental,Oral and Maxillofacial Surgery Specialist",style: TextStyle(fontSize: 16.0,fontWeight: FontWeight.w500,color: Colors.pink),),
